...
import torchvision
from torchvision.transforms import Lambda, Normalize, RandomVerticalFlip, RandomHorizontalFlip, ToTensor, Resize, ColorJitter, RandomAutocontrast, RandomInvert, RandomRotation, Compose, CenterCrop
